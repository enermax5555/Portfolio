        ...
        <main className='flex justify-center lg:fixed text-white cursor-default font-bold'>
            <header className="flex space-x-10 p-1">
                <div className='w-80 lg:w-auto bg-black p-2 select-none'>
                    ...
                    <nav className={`${arrow ? 'h-auto w-auto text-center text-gray-600 pt-5 pt-5 pb-5' : 'collapse pb-5 scale-75 text-center w-auto opacity-0 h-0 w-0 cursor-normal'} font-montserrat duration-300`}>
                    ...
                    <div className='flex pb-3 justify-center scale-125 text-gray-600 '>
                        <div className='hover:text-white hover:animate-pulse hover:text-white-600 duration-500'>
                            <button onClick={() => setArrow(!arrow)}>
                                ...
                                <div className={`${arrow ? 'invisible h-0 w-0' : 'visible pt-5'}`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
